...
return [
    ...
    // if it's not defined in the URL. This requires the middleware `LaravelSessionRedirect.php` to redirect
    // user to computed localized url.
    ...
    // would be identical.
    //
    // If in addition LaravelLocalizationRedirectFilter is active, then
